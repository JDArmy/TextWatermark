...
# 组合字符，如音标等
CONFUSABLES_CHARS_START_WITH: str = '<span style="'
...
CONFUSABLES_CHARS: dict = {
    ...
    "background-color-white-green-1": [
        "background-color:#fff",
        "background-color:#fef",
    ],
    "background-color-white-green-2": [
        "background-color:#fff",
    ...
    "background-color-black-green-2": [
        "background-color:#000",
    ...
    "border-bottom-white-dashed-2": [
        "border-bottom: ;",
        "border-bottom: 1px dashed #ddd;",
    ],
    "border-bottom-white-dashed-3": [
        "border-bottom: ;",
    ...
    "border-right-white-dashed-2": [
        "border-right: ;",
        "border-right: 1px dashed #ddd;",
    ],
    "border-right-white-dashed-3": [
        "border-right: ;",
